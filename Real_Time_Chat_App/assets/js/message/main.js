			...
			if (jsonData.length == 1) {
				for (var i = 0; i < jsonData.length; i++) {
					if (jsonData[i]['blocked_from'] == unique_id) {
						...
						$('#messageText').attr('placeholder', 'You have been block by this user');
						...
						$('#messageText').attr('disabled', '');
						$('#messageText').attr('placeholder', 'You have block this user');
				...
				$('#messageText').attr('placeholder', 'Type you message');
				$('#btn_block').html('Block User');
