	...
	<section id="main" class="bg-dark">
		<div id="chat_user_list">
			<div id="owner_profile_details">
				...
				<div id="owner_profile_text" class="">
					...
					<a class="text-decoration-none" href="" id="logout">Logout</a>
				</div>
			</div>
		...
		<div id="chatbox">
			<div id="data_container" class="">
				<div id="bg_image"></div>
				<h2 class="mt-0">Hi there! It seems you had</h2>
				<h2>a very busy day!</h2>
				<p class="text-center my-2">Connect to your computer via Internet. Remember that you <br> must have a stable internet connection to use out<br> application  in your computer.</p>
			</div>
		...
		<div id="details_of_user">
			...
			<button class="btn" id="btn_block">Block User</button>
		</div>
	</section>
	<div id="update_container">
		<div style="background-color:#F5F6FA;" class="p-3 d-flex justify-content-between align-items-center">
			<h5 id="update_container_title" class="m-0 p-0">Edit profile</h5>
		...
		<form class="" id="form_details" autocomplete="off">
			...
			<button class="btn btn-block" id="update_btn">
