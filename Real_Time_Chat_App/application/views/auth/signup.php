			...
			<div class="row form_row">
				<div class="col-lg-4 bg-white px-3 py-3" id="form_col">
					<form autocomplete="off" id="form_signup" enctype="multipart/form-data">
						...
						<h6 class="text-center">Already have an account ? <a href="<?php echo base_url();?>">Link</a></h6>
						...
						<div class="field_container">
							...
							<div class="form-group" id="file_container">
								<div class="custom-file">
								    ...
								    <label class="custom-file-label" for="file_avtar">Choose file</label>
								</div>
							</div>

							<div class="form-group">
								<button class="btn btn-block"id="btn_signup">
									<span>Sign up</span>
								</button>
							</div>
						</div>
